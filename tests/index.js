...
.equal( d1.date(), "Wed Jun 16 2010 16:45:55" )
...
.equal( d3.date("hh:mmZ", 1),     "00:31+01" )
.equal( d3.date("hh:mmZ", 2),     "01:31+02" )
.equal( d3.date("hh:mmZ", -1),    "22:31-01" )
.equal( d3.date("hh:mmZ", -2),    "21:31-02" )
.equal( d3.date("hh:mmZ", -2.1),  "21:25-02:06" )
.equal( d3.date("hh:mmZ", -2.5),  "21:01-02:30" )

.equal( d3.date("hh:mmZZ", 0),    "23:31Z" )
.equal( d3.date("hh:mmZZ", 1),    "00:31+01" )
.equal( d3.date("hh:mmZZ", 2),    "01:31+02" )
.equal( d3.date("hh:mmZZ", -1),   "22:31-01" )
.equal( d3.date("hh:mmZZ", -2),   "21:31-02" )
.equal( d3.date("hh:mmZZ", -2.1), "21:25-0206" )
.equal( d3.date("hh:mmZZ", -2.5), "21:01-0230" )

.equal( d3.date("hh:mmZZZ", 0),    "23:31Z" )
.equal( d3.date("hh:mmZZZ", 1),    "00:31+01:00" )
.equal( d3.date("hh:mmZZZ", 2),    "01:31+02:00" )
.equal( d3.date("hh:mmZZZ", -1),   "22:31-01:00" )
.equal( d3.date("hh:mmZZZ", -2),   "21:31-02:00" )
.equal( d3.date("hh:mmZZZ", -2.1), "21:25-02:06" )
.equal( d3.date("hh:mmZZZ", -2.5), "21:01-02:30" )

.equal( d3.date("hh:mmZZZZ", 0),    "23:31Z" )
.equal( d3.date("hh:mmZZZZ", 1),    "00:31+0100" )
.equal( d3.date("hh:mmZZZZ", 2),    "01:31+0200" )
.equal( d3.date("hh:mmZZZZ", -1),   "22:31-0100" )
.equal( d3.date("hh:mmZZZZ", -2),   "21:31-0200" )
.equal( d3.date("hh:mmZZZZ", -2.1), "21:25-0206" )
.equal( d3.date("hh:mmZZZZ", -2.5), "21:01-0230" )

.equal( (new Date(d3)).tz(2).date("HH:mmZZ"),    "01:31+02" )
