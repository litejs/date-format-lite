...
Date.masks.isoSS = "UTC:YYYY-MM-DDThh:mm:ss.SS[Z]"
Date.masks.isoLocal = "YYYY-MM-DDThh:mm:ss.SSZ"
...
.equal( new Date("xx").date("iso"), "Invalid Date")
...
.equal( addDate.add(100, "S").date("isoSS"), "2012-04-18T22:41:50.223Z" )
