...
.equal( d3.format("hh:mmZ", -2.1),  "21:25-02:06" )
.equal( d3.format("hh:mmZ", -2.5),  "21:01-02:30" )

.equal( d3.format("hh:mmZZ", 0),    "23:31Z" )
.equal( d3.format("hh:mmZZ", 1),    "00:31+01" )
.equal( d3.format("hh:mmZZ", 2),    "01:31+02" )
.equal( d3.format("hh:mmZZ", -1),   "22:31-01" )
.equal( d3.format("hh:mmZZ", -2),   "21:31-02" )
.equal( d3.format("hh:mmZZ", -2.1), "21:25-0206" )
.equal( d3.format("hh:mmZZ", -2.5), "21:01-0230" )

.equal( d3.format("hh:mmZZZ", 0),    "23:31Z" )
.equal( d3.format("hh:mmZZZ", 1),    "00:31+01:00" )
.equal( d3.format("hh:mmZZZ", 2),    "01:31+02:00" )
.equal( d3.format("hh:mmZZZ", -1),   "22:31-01:00" )
.equal( d3.format("hh:mmZZZ", -2),   "21:31-02:00" )
.equal( d3.format("hh:mmZZZ", -2.1), "21:25-02:06" )
.equal( d3.format("hh:mmZZZ", -2.5), "21:01-02:30" )

.equal( d3.format("hh:mmZZZZ", 0),    "23:31Z" )
.equal( d3.format("hh:mmZZZZ", 1),    "00:31+0100" )
.equal( d3.format("hh:mmZZZZ", 2),    "01:31+0200" )
.equal( d3.format("hh:mmZZZZ", -1),   "22:31-0100" )
.equal( d3.format("hh:mmZZZZ", -2),   "21:31-0200" )
.equal( d3.format("hh:mmZZZZ", -2.1), "21:25-0206" )
.equal( d3.format("hh:mmZZZZ", -2.5), "21:01-0230" )
...
.equal( "2005-06-07T01:02:03.004Z".date().startOf("sec").format("isoSS"), "2005-06-07T01:02:03.000Z")
.equal( "2005-06-07T01:02:03.004Z".date().startOf("min").format("isoSS"), "2005-06-07T01:02:00.000Z")
.equal( "2005-06-07T01:02:03.004Z".date().startOf("hour").format("isoSS"), "2005-06-07T01:00:00.000Z")
.equal( "2005-06-07T01:02:03.004Z".date().startOf("day").format("isoSS"), "2005-06-07T00:00:00.000Z")
.equal( "2005-06-07T01:02:03.004Z".date().startOf("week").format("isoSS"), "2005-06-02T00:00:00.000Z")
.equal( "2005-06-07T01:02:03.004Z".date().startOf("month").format("isoSS"), "2005-06-01T00:00:00.000Z")
.equal( "2005-06-07T01:02:03.004Z".date().startOf("year").format("isoSS"), "2005-01-01T00:00:00.000Z")
